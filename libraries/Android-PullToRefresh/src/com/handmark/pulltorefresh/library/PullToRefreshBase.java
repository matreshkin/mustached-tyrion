...
import com.handmark.pulltorefresh.library.internal.SimpleActivityLoadingLayout;
...
//					Log.i("InformerPull", "onTouchUp>>> list in touch mode: " + mRefreshableView.isInTouchMode());
//					final Handler postCheckHandler = new Handler();
//					postCheckHandler.postDelayed(new Runnable() {
//						
//						@Override
//						public void run() {
//							Log.i("InformerPull", "onTouchUp 10>>> list in touch mode: " + mRefreshableView.isInTouchMode());
//						}
//					}, 10);
//					postCheckHandler.postDelayed(new Runnable() {
//						
//						@Override
//						public void run() {
//							Log.i("InformerPull", "onTouchUp 1000>>> list in touch mode: " + mRefreshableView.isInTouchMode());
//						}
//					}, 1000);
					return true;
				}
...
//			mRefreshableViewWrapper.removeView(mHeaderLayout);
		}
		if (mMode.showHeaderLoadingLayout()) {
...
//		int topOffset = getTopContentOffset();		
//		final int maximumPullScroll = (int) (getMaximumPullScroll() * 1.2f);
//		int pLeft = getPaddingLeft();
//		int pTop = -maximumPullScroll;
//		int pRight = getPaddingRight();
//		int pBottom = getPaddingBottom();
//		int offset = pTop+topOffset+getFirstVisibleItemTopY();
//		if (getFirstVisibleItemTopY() == 0)
//			offset = pTop;
//		setPadding(pLeft, offset, pRight, pBottom);
	}
	
	protected void resetPreparedToPullState() {
//		final int maximumPullScroll = (int) (getMaximumPullScroll() * 1.2f);
//		int pLeft = getPaddingLeft();
//		int pTop = -maximumPullScroll;
//		int pRight = getPaddingRight();
...
//		setPadding(pLeft, pTop, pRight, pBottom);
	...
	protected int getFirstVisibleItemTopY() {
		return 0;
	}
	...
	public static enum AnimationStyle {
		...
		/**
		 * This is the default circular progress bar.
		 */
		SIMPLE_ACTIVITY;
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				...
				case SIMPLE_ACTIVITY:
					return new SimpleActivityLoadingLayout(context, mode, scrollDirection, attrs);
			}
		}
	}
